				...
				<section>
						...
						<div class="container-fluid">
							...
							<div class="collapse navbar-collapse" id="navbarSupportedContent">
								<ul class="navbar-nav me-auto mb-2 mb-lg-0">
									<li class="nav-item">
										<a class="nav-link " aria-current="page" href="/main/map">📄지도보기</a>
									</li>
									<li class="nav-item">
					...
					<div class="card">
						...
						<div class="card-body form-card">
							...
							<p class="card-text">☂지역Edition:7</p>
							<hr>
							<p class="form-card-free">🌂프리Edition:5</p>
							<h2 class="form-card-total-left">${s.leftUmbrella}개</h2>
