    ...
    <article id="main">
        <header>
            ...
            <c:choose >
                <c:when test="${URL=='day'}">
                    <h2>일일권 결제</h2>
                    <p>첫 대여후 대여시간(1시간/2시간)안에 정상반납시 24시간동안은 대여횟수 제한없이 재 대여가능</p>
                </c:when>
        ...
        <section id="one" class="wrapper style1 special">
            <div class="inner">
                <header class="major">
                    ...
                    <c:choose>
                        <c:when test="${URL=='areaEdition'}">
                            <p id="total-selected-ticket">지역Edition일일권(12시간)</p>
                            <h4 id="total-price">700원</h4>
                        </c:when>
                        <c:otherwise>
                            <p id="total-selected-ticket">프리Edition일일권(12시간)</p>
                            <h4 id="total-price">1000원</h4>
                        </c:otherwise>
                    </c:choose>
                </header>
                <a href="/charge/charge" class="button fit ">다음</a>
            </div>
        </section>
    </article>
